...
public class StatusResult implements RakoCommandResult {
    ...
    StatusResult(String input) throws RakoException {
        ...
        if (matcher.matches()) {
            try {
                ...
                throw new RakoException("Could not understand: " + input, nfX);
            }
        } else {
            throw new RakoException("Could not understand: " + input);
        }
    }
